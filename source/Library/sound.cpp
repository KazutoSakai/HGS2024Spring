...
HRESULT CSound::Init(HWND hWnd)
{
	...
	// COMライブラリの初期化
	HRESULT tmpResult = CoInitializeEx(NULL, COINIT_MULTITHREADED);
	...
	// サウンドデータの初期化
	for (int nCntSound = 0; nCntSound < SOUND_LABEL::MAX; nCntSound++)
	{
		HANDLE hFile;
		DWORD dwChunkSize = 0;
...
/// <param name="pChunkSize"></param>
/// <param name="pChunkDataPosition"></param>
/// <returns></returns>
...
/// <param name="dwBufferoffset"></param>
/// <returns></returns>
